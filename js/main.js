...
$('.partner_flex').exists(function() {
   
 /*   setTimeout(function() {
    $('.partner_flex .partners_link a').addClass('loadpic');
    }, 7500);*/
  
  $(window).scroll(function() {
	if (($('.about_wrap').offset().top) <= $(this).scrollTop()) {
		$('.partner_flex .partners_link a').addClass('loadpic');
	} else {
		$('.partner_flex .partners_link a').removeClass('loadpic');
	}
});  
